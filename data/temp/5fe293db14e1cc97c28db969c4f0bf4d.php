<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"/www/wwwroot/web/application/user/view/member/grouplist.html";i:1551974656;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1564129740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
				   ...
				   <tbody>
				      <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					    <tr class="imgclass">
						  ...
						  <td class="text-center"><?php echo $vo['reg_time']; ?></td>
						  
						  <td class="text-center">
						   <?php switch($vo['status']): case "2": ?>已接通<?php break; default: ?>
										未接通
								<?php endswitch; ?>
					      </td>		
