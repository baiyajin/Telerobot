<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/www/wwwroot/web/application/user/view/tsr/index.html";i:1551953750;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1569485441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="col-lg-12">
	...
	<div class="main-box clearfix">	
		<header class="main-box-header clearfix">
		  <div class="pull-left">
			  <h1><i style="font-size: 30px;margin-right: 10px;" class="icon iconfont icon-zuoxi1"></i>座席代表</h1>
				...
				<tbody>
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						    ...
						    <td class="text-center">
								...
								<td class="text-center">
									  <a href="<?php echo url('Tsr/simpage',['gId'=>$vo['id']]); ?>">成员列表</a>
										<a href="javascript:void(0);" onclick="showModal('<?php echo $vo['id']; ?>');">编辑</a>
										<a href="javascript:void(0);" onclick="delgroup('<?php echo $vo['id']; ?>');">删除</a>
								</td>
							</tr>
								<?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
	...
	<script type="text/javascript">
		...
		function showModal(id){
			 ...
			 if(id){
					 ...
					 var url = "<?php echo url('user/Tsr/getGroupInfo'); ?>";	
					 $.ajax({
							url : url,
							dataType : "json", 
							type : "post",
	 ...
	 //检查表单的必填项
		function checkform(){
			 ...
			 var href = "<?php echo url('user/Tsr/add'); ?>";
