<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/www/wwwroot/web/application/user/view/system/setting.html";i:1551953748;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1569485441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
             ...
             <form id="form" method="post" class="form-horizontal margintop" enctype="multipart/form-data" method="post">  
	            ...
	            <div class="form-group">
			        ...
			        <div class="col-lg-10 col-sm-10">
			        	<input type="text" class="form-control textwidth" placeholder="网站名称" name="websitename" id="websitename" value="<?php echo (isset($res['name']) && ($res['name'] !== '')?$res['name']:""); ?>" />
			        </div>
	            </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-10">
                      <input type="text" class="form-control textwidth" placeholder="官方网址" name="websiteURL" id="websiteURL" value="<?php echo (isset($res['domain']) && ($res['domain'] !== '')?$res['domain']:""); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-sm-10">
                      <input type="text" class="form-control textwidth" placeholder="办公地址" name="Contactaddress" id="Contactaddress" value="<?php echo (isset($res['address']) && ($res['address'] !== '')?$res['address']:""); ?>" />
                    </div>
                </div>
	            ...
	            <div class="form-group">
		          ...
		          <div class="col-lg-10 col-sm-10">
		               <textarea name="desc" placeholder="描述" id="desc" style="width: 80%;height:100px;"><?php echo (isset($res['desc']) && ($res['desc'] !== '')?$res['desc']:""); ?></textarea>
		          </div>
		        </div>
	            ...
	            <div class="form-group">
			          ...
			          <div class="col-lg-10 col-sm-10">
			               <?php echo widget('common/Form/show',array(array('type'=>'picture','name'=>'cover'),$cover)); ?>      
	            ...
	            <div class="form-group">
		          ...
		          <div class="col-lg-10 col-sm-10">
		            <input type="text" class="form-control textwidth" placeholder="网站备案号" name="Websiterecordnumber" id="Websiterecordnumber" value="<?php echo (isset($res['icp']) && ($res['icp'] !== '')?$res['icp']:""); ?>" />
		          </div>
	            </div>
	            ...
	            <div class="form-group">
			          <label class="col-lg-2 control-label">网站联系方式:</label>
			           <div class="col-lg-10 col-sm-10">
                       <input type="text" class="form-control textwidth" placeholder="电话号码" name="contactmode" id="contactmode" value="<?php echo (isset($res['contact']) && ($res['contact'] !== '')?$res['contact']:""); ?>" />
                     </div>
	            </div>
              
		        <div class="form-group">
		          <div class="col-lg-offset-2 col-lg-10">   
		             <input type="hidden" name="configId" id="configId" value="<?php echo (isset($res['domain']) && ($res['domain'] !== '')?$res['domain']:''); ?>" />    
         ...
         success: function(data) {
           if (data.code == 0) {
             alert(data.msg + ' 页面即将自动跳转~');
			  location.href = data.data+"<?php echo url('User/System/setting'); ?>";
            // location.reload();
          }else{
			alert(data.msg);
