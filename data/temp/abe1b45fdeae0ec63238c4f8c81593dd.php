<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"/www/wwwroot/web/application/user/view/member/group.html";i:1551953768;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1564129740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="col-lg-12">
	<div class="main-box clearfix">	
		<header class="main-box-header clearfix">
		  <div class="pull-left">
			  <h1><i style="font-size: 30px;margin-right: 10px;" class="icon iconfont icon-fenzu"></i>分组列表</h1>
			  <a class="btn btn-primary" href="<?php echo url('addGroup'); ?>">添加分组</a>
		  </div>
		</header>
			  ...
			  <div class="table-responsive">
				  ...
				  <table class="table table-bordered table-hover">
				   ...
				   <tbody>
						  ...
						  <td class="text-center"><?php echo $arr['number']; ?></td> 
						  <td class="text-center">
                              <a class="btn btn-primary" data-toggle="tooltip" title="查看会员" href="<?php echo url('groupList',['groupId'=>'0']); ?>">
                                                                                             分组会员
                              </a>
					 	  </td>
						</tr>
				       ...
				       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					    <tr class="imgclass">
						  ...
						  <td class="text-center">
						     <a class="btn btn-primary" data-toggle="tooltip" title="查看会员" href="<?php echo url('groupList',['groupId'=>$vo['id']]); ?>">
                                                                                             分组会员
                             </a>
                             <a class="btn btn-primary" data-toggle="tooltip" title="编辑" href="<?php echo url('editGroup',['id'=>$vo['id']]); ?>">
                                 <i class="fa fa-pencil"></i>
                             </a>
                             <a class="btn btn-danger" data-toggle="tooltip" title="删除" href="javascript:void(0)" onclick="delGroup(<?php echo $vo['id']; ?>)">
...
//删除红包
 function delGroup(id){
    var r=confirm('确认删除?');
     ...
     $.post("<?php echo url('delGroup'); ?>",{'id':id},function(data){
		if(data){
			alert(data);
		}else{
...
//修改状态
 function setstatus(id,status){
 	 ...
 	 $.post("<?php echo url('gradeStatus'); ?>",{'id':id,'status':status},function(data){
 			if(data){
 				alert(data);
 			}else{
 				window.location.href=window.location.href;
