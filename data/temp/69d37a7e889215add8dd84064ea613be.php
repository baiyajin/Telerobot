<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"/www/wwwroot/web/application/user/view/sms/sendsms.html";i:1551953756;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1569485441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
 ...
 <script type="text/javascript">
	  ...
	  function getcontent(obj){
			...
			var val = $(obj).val();
				...
				<?php if(is_array($tpllist) || $tpllist instanceof \think\Collection || $tpllist instanceof \think\Paginator): $i = 0; $__LIST__ = $tpllist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		
					if(<?php echo $vo['id']; ?> == val){
					
							$("#content").val('<?php echo $vo['conent']; ?>');
...
// 			}
			...
			var href = "<?php echo url('User/Sms/sendSms'); ?>";
