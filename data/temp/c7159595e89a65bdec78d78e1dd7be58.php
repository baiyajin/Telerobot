<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"/www/wwwroot/web/application/user/view/menu/index.html";i:1551953758;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1569485441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<header class="main-box-header clearfix">
		  <div class="pull-left">
			  <h1><i style="font-size: 30px;margin-right: 10px;" class="icon iconfont icon-caidanguanli"></i>菜单管理</h1>
                ...
                <table class="table table-hover">
                    ...
                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $menu['level_show']; switch($menu['pid']): case "0": ?>
