<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"/www/wwwroot/web/application/user/view/weixin/add.html";i:1551953754;s:55:"/www/wwwroot/web/application/user/view/public/base.html";i:1569485441;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8"/>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <header class="main-box-header clearfix">
		   <div class="pull-left">
			  <h1><span><?php echo (isset($current) && ($current !== '')?$current:''); ?></span>公众号</h1>
		   </div>
		</header>
         </div>
	  <div class="panel-body">
	        ...
	        <form id="form" method="post" onsubmit="return checkform();" class="form-horizontal" enctype="multipart/form-data" method="post">	
		      ...
		      <div class="main-box-body clearfix">
                 <div class="form-group" <?php if((isset($wechat['apiur']) && ($wechat['apiur'] !== '')?$wechat['apiur']:'0') == '1'): ?>style="display:none;"<?php endif; ?>>
					<label class="col-lg-2 control-label">接口地址：</label>
					<div class="col-lg-10 col-sm-10">
                       <input readonly type="text" class="form-control textwidth"  placeholder="请先以下信息保存后显示" value="<?php echo (isset($wxlist['apiurl']) && ($wxlist['apiurl'] !== '')?$wxlist['apiurl']:''); ?>" >
					</div>
			    </div>
			    ...
			    <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="wxname" id="wxname" value="<?php echo (isset($wxlist['wxname']) && ($wxlist['wxname'] !== '')?$wxlist['wxname']:''); ?>" />
					</div>
			    </div>
			    ...
			    <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="wxid" id="wxid" value="<?php echo (isset($wxlist['wxid']) && ($wxlist['wxid'] !== '')?$wxlist['wxid']:''); ?>" />
					</div>
			    </div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" placeholder="关注引导地址" name="url" id="url" value="<?php echo (isset($wxlist['url']) && ($wxlist['url'] !== '')?$wxlist['url']:''); ?>" />
					</div>
			    </div>
			    ...
			    <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="weixin" id="weixin" value="<?php echo (isset($wxlist['weixin']) && ($wxlist['weixin'] !== '')?$wxlist['weixin']:''); ?>" />
					</div>
			    </div>
			     ...
			     <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
	                      <?php echo widget('common/Form/show',array(array('type'=>'picture','name'=>'headImg'),$picdata)); ?>			
					</div>
			    </div>
			     ...
			     <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="appid" id="appid" value="<?php echo (isset($wxlist['appid']) && ($wxlist['appid'] !== '')?$wxlist['appid']:''); ?>" />
					</div>
			    </div>
			    ...
			    <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="appsecret" id="appsecret" value="<?php echo (isset($wxlist['appsecret']) && ($wxlist['appsecret'] !== '')?$wxlist['appsecret']:''); ?>" />
					</div>
			    </div>
			     <div class="form-group">
					<label class="col-lg-2 control-label">模板id：</label>
					<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="template_id" id="template_id" value="<?php echo (isset($wxlist['template_id']) && ($wxlist['template_id'] !== '')?$wxlist['template_id']:''); ?>" />
					</div>
			    </div>
			    <div class="form-group">
					<label class="col-lg-2 control-label">公众号二维码：</label>
					<!--<div class="col-lg-10 col-sm-10">
						<input type="text" class="form-control textwidth" name="qr" id="qr" value="<?php echo (isset($wxlist['qr']) && ($wxlist['qr'] !== '')?$wxlist['qr']:''); ?>" />
					</div>-->
					<div class="col-lg-10 col-sm-10">
	                      <?php echo widget('common/Form/show',array(array('type'=>'picture','name'=>'ewm'),$picewm)); ?>	
					</div>
			    ...
			    <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
					   <select name="type" class="form-control textwidth">
                           <option value="1" 
                            <?php if((isset($wxlist['type']) && ($wxlist['type'] !== '')?$wxlist['type']:'') == '1'): ?>
		                     selected 
		                    <?php endif; ?>
                           >订阅号</option>
                           <option value="2" 
                            <?php if((isset($wxlist['type']) && ($wxlist['type'] !== '')?$wxlist['type']:'') == '2'): ?>
		                     selected 
		                    <?php endif; ?>
                           >认证订阅号</option>
                           <option value="3"
                            <?php if((isset($wxlist['type']) && ($wxlist['type'] !== '')?$wxlist['type']:'') == '3'): ?>
		                     selected 
		                    <?php endif; ?>
                           >服务号</option>
                           <option value="4" 
                            <?php if((isset($wxlist['type']) && ($wxlist['type'] !== '')?$wxlist['type']:'') == '4'): ?>
		                     selected 
		                    <?php endif; ?>
                           >认证服务号</option>
                       </select>
			     ...
			     <div class="form-group">
					...
					<div class="col-lg-10 col-sm-10">
					  ...
					  <?php if((isset($wxlist['is_default']) && ($wxlist['is_default'] !== '')?$wxlist['is_default']:'0') == '0'): ?>
                       checked 
                      <?php endif; ?>
					  /> 否
                      &nbsp;<input type="radio" name="is_default" value="1" 
                      <?php if((isset($wxlist['is_default']) && ($wxlist['is_default'] !== '')?$wxlist['is_default']:'') == '1'): ?>
                       checked 
                      <?php endif; ?>
                      /> 是               
					</div>
			  ...
			  <div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">	<!--   target-form="form-horizontal" -->	
				    <input type="hidden" name="watchId" id="watchId" value="<?php echo (isset($wxlist['id']) && ($wxlist['id'] !== '')?$wxlist['id']:''); ?>" />			  
