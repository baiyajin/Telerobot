...
class User extends Base{
	...
	public function _initialize(){
		...
		$ulist = db('admin')->field("role_id,user_type")->where('id',$user["uid"])->find();
		...
		$uid = $user["uid"];
	  	\think\Log::record('###user_id='.$uid.'time='.date("Y-m-d H:i:s",time()).'function='.$this->url);
